...
function getName() {
    ...
    axios
    .post("http://15.152.40.225:3000/user/getName", {
        userid
    })
    .then((response) => {
...
function getCardNews() {
  ...
  axios
    .get("http://15.152.40.225:3000/user/getCardNews")
    .then((response) => {
      ...
      document.getElementById("profileImage").src = `http://15.152.40.225:3000${firstCardNews.userInfo.profileImage}`;
      ...
      document.getElementById("cardNewsImage").src = `http://15.152.40.225:3000${ firstCardNews.cardNews.image_url}`;
      ...
      document.getElementById("profileImage2").src = `http://15.152.40.225:3000${secondCardNews.userInfo.profileImage}`;
      ...
      document.getElementById("cardNewsImage2").src = `http://15.152.40.225:3000${secondCardNews.cardNews.image_url}`;
      ...
      document.getElementById("profileImage3").src = `http://15.152.40.225:3000${thirdCardNews.userInfo.profileImage}`;
      ...
      document.getElementById("cardNewsImage3").src = `http://15.152.40.225:3000${thirdCardNews.cardNews.image_url}`;
